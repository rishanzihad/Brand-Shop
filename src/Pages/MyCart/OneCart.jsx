...
const OneCart = ({ cart }) => {
    ...
    const handleDelete = (_id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                    console.log(_id)
                fetch(`https://tech-server-sand.vercel.app/carts/${_id}`, {
                    method: 'DELETE'
                })
    ...
    return (
        ...
        <div className="relative flex  h-[520px]  text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
            ...
            <div className='w-1/2 lg:flex-1'> 
                ...
                <div className="relative flex flex-1  max-w-[20rem] h-full mt-4 flex-col rounded-r-lg  bg-gradient-to-tr from-red-600 to-green-400 bg-clip-border p-8 text-white shadow-md shadow-pink-500/40">
                    <div className="relative pb-8 m-0 mb-8 overflow-hidden text-center text-gray-700 bg-transparent border-b rounded-none shadow-none border-white/10 bg-clip-border">
                        ...
                        <h1 className="flex justify-center gap-1  md:mt-6 font-sans antialiased font-normal tracking-normal text-white text-3xl md:text-5xl">
                            <span className=" mt-2 md:text-4x text-2xl">$</span>{price}
